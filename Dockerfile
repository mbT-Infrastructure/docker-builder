...
RUN install-autonomous.sh install Basics Go Python Scripts ScriptsAdvanced ScriptsDevelopment \
    ScriptsHelper \
    && apt update -qq && apt install -y -qq autoconf automake build-essential ccache cmake \
    libclang-dev libfreetype6-dev libgnutls28-dev libnuma-dev libsdl2-dev libtool libxcb-shm0-dev \
